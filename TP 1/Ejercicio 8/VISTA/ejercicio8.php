    ...
    <?php include('../../header.php'); ?>
        <form action="..\CONTROLADOR\ejecuta8.php" method="get">
            ...
            <label for="estudiante">Estudiante o no?
                <label> SI <input type="radio" id="estudiante" name="estudiante" value="estudiante">
                <label> NO <input type="radio" id="no-estudiante" name="no-estudiante" value="no-estudiante">
            <br>
